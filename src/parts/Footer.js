...
const navigation = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/farab.ii/",
    icon: (props) => (
  ...
  // {
  //   name: "GitHub",
  //   href: "https://www.linkedin.com/in/muhammad-farabby-rifaah-4bb13b15a/",
  //   icon: (props) => (
  //     <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  //       <path
  //         fillRule="evenodd"
          ...
          >
            <g fill="none" fillRule="evenodd">
              <rect
                ...
                fill="currentColor"
                rx="4"
                className="color117EB8 svgShape"
              ></rect>
              <path
                fill="#ffffff"
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:mt-0 md:order-1">
          <p className="text-center text-base text-gray-400">
            &copy; {currentYear} farabirifaah.com.
          </p>
        </div>
      </div>
    </footer>
