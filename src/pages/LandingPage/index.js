...
const offers = [
  {
    name: "Customizing Product",
    description: "Customize based on request",
    href: "#",
  },
  {
...
const trendingProducts = [
  {
    id: 1,
    name: "Notebook Ring Full Print Papper Include Calendar & Logo (Pre Order)",
    color: "Minimum order 100 pcs",
    price: "Rp. 65.000",
    href: "#",
    imageSrc:
      "https://smb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com/product/image/07022023/63d781697ec1757562251f21/63e1ed0ccaacd663abf2c578/814754e627539ec3525a91d526d01e.jpeg",
    imageAlt: "Notebook Ring Full Print Papper Include Calendar & Logo",
    availableColors: [
  ...
  {
    id: 2,
    name: "Sajadah Traveling ASK Promerch Custom Kustom",
    color: "Minimum order 100 pcs",
    price: "Rp. 95.000",
    href: "#",
    imageSrc:
      "https://smb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com/product/image/30012023/63d781697ec1757562251f21/63d79102ac91024a2d56937a/c7e426f66d8ad6341d29bc594bbded.jpeg",
    imageAlt: "Notebook Ring Full Print Papper Include Calendar & Logo",
    availableColors: [
      // { name: "Black", colorBg: "#111827" },
      // { name: "Brass", colorBg: "#FDE68A" },
  ...
  {
    id: 3,
    name: "Hanging Pouch Tas ASK Promerch Custom",
    color: "Minimum order 100 pcs",
    price: "Rp. 120.000",
    href: "#",
    imageSrc:
      "https://smb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com/product/image/03022023/63d781697ec1757562251f21/63dcb4ac920cd5059464fd64/827405c2caf6d62d33d6f6e280e361.jpeg",
    imageAlt: "Notebook Ring Full Print Papper Include Calendar & Logo",
    availableColors: [
      // { name: "Black", colorBg: "#111827" },
      // { name: "Brass", colorBg: "#FDE68A" },
  ...
  {
    id: 4,
    name: "Tote Bag Canvas/Kanvas Tebal (Pre Order)",
    color: "Minimum order 100 pcs",
    price: "Rp. 85.000",
    href: "#",
    imageSrc:
      "https://smb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com/product/image/06022023/63d781697ec1757562251f21/63e0b769870b02206eeb6fa1/ecb942fab349706fd8aff774e06be5.jpeg",
    imageAlt: "Notebook Ring Full Print Papper Include Calendar & Logo",
    availableColors: [
      // { name: "Black", colorBg: "#111827" },
      // { name: "Brass", colorBg: "#FDE68A" },
...
const collections = [
  {
    ...
    description:
      "Included Bag, Name Tag, Card Holder, Sling Bag, Backpack, ID Card, Etc..",
    imageSrc:
      "https://smb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com/product/image/03022023/63d781697ec1757562251f21/63dcb84c6cbe839f87d825f2/dc37330eca8c87d68b89c54e50e911.jpeg",
    imageAlt:
  ...
  {
    name: "Custom Book",
    description: "Journals and notebook",
    imageSrc:
      "https://smb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com/product/image/07022023/63d781697ec1757562251f21/63e1ef44caacd663abf2d461/3ea47819f74c8fbcbd0faaea8fe47d.jpeg",
    imageAlt:
...
const testimonials = [
  {
    id: 1,
    quote: "Sangat Terbaik pesan disini!",
    attribution: "Customers, Loket.com",
  },
  {
    id: 2,
    quote: "Pesanan sangat bagus, dan berkesan untuk karyawan!",
    attribution: "Customers, Samsung Indonesia",
  },
  {
    id: 3,
    quote: "Dari segi product, pelayanan, dan pengiriman, sangat baik",
    attribution: "Customers, Bank Central Asia",
  },
];
        ...
        <nav aria-label="Top">
          ...
          <div className="bg-gray-900">
            <div className="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
              ...
              <p className="flex-1 text-center text-sm font-medium text-white lg:flex-none"></p>
                  ...
                  <div className="hidden lg:flex lg:items-center">
                    <a href="#">
                      ...
                      <img
                        ...
                        src="https://ugc.production.linktr.ee/YvLSWmhKQdGK98BetzhR_RDs06oi39NN78AP2"
                        alt=""
                      />
                    </a>
                  </div>
      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          ...
          <div className="relative">
            <div
              aria-hidden="true"
              className="hidden absolute w-1/2 h-full bg-gray-900 lg:block"
            />
                ...
                <div className="max-w-2xl mx-auto py-24 lg:py-64 lg:max-w-none">
                  <div className="lg:pr-16">
                    ...
                    <div className="mt-6">
                      <a
                        href="#"
                        className="inline-block bg-yellow-primary border border-transparent py-3 px-8 rounded-md font-medium text-gray-900 hover:bg-yellow-primary-hover"
                      >
                        Shop Productivity
                      </a>
                    </div>
            ...
            <div className="w-full h-48 sm:h-64 lg:absolute lg:top-0 lg:right-0 lg:w-1/2 lg:h-full">
              <img
                src="https://padiumkm.id/_next/image?url=https%3A%2F%2Fsmb-padiumkm-images-public-prod.oss-ap-southeast-5.aliyuncs.com%2Fseller%2Fbanner_image%2F16022023%2F63d781697ec1757562251f21%2F939d9e14ffdb31d68850ef9c987055.png&w=1920&q=75"
                alt=""
        ...
        <section aria-labelledby="trending-heading" className="bg-white">
          <div className="py-16 sm:py-24 lg:max-w-7xl lg:mx-auto lg:py-32 lg:px-8">
            <div className="px-4 flex items-center justify-between sm:px-6 lg:px-0">
              ...
              <a
                href="#"
                className="hidden sm:block text-sm font-semibold text-gray-600 hover:text-gray-500"
              >
        ...
        <div className="relative overflow-hidden">
          ...
          >
            <div className="max-w-2xl mx-auto lg:max-w-none">
              <h2
                id="sale-heading"
                className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-2xl lg:text-3xl"
              >
                Jadikan Brand kamu melekat di hati setiap pelanggan dengan
                Souvenir dan Merchandise Kustom Ekslusif hanya dari ASK Promerch
              </h2>
              <p className="mt-4 max-w-xl mx-auto text-xl text-gray-600">
                Konsultasikan keinginan Brand kamu sebelum pesan agar Souvenir &
                Merchandise dapat sesuai dengan kebutuhan dan Identitas Brand
                kamu, GRATIS!
              </p>
              <a
                href="#"
                className="mt-6 inline-block w-full bg-yellow-primary border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-gray-800 sm:w-auto"
              >
                Contact Me
              </a>
            </div>
